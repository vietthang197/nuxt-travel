<script setup lang="ts">
  ...
  const categoryList = await useFetch<BasicResponse<CategoryResponse>>(runtimeConfig.public.baseApiUrl + '/category')
  console.log('categoryList', categoryList.data.value.data)
</script>
<template>
  <div class="container mx-auto">
    <div class="relative text-center">
      ...
      <h2 class="relative z-10 text-xl font-bold p-2">ĐIỂM ĐẾN</h2>
    ...
    <div class="container mx-auto px-4 py-8 grid grid-cols-1 md:grid-cols-2 gap-4">
      <div class="col-span-1">
        ...
        <div class="grid grid-cols-1 gap-4">
          <CommonBlogCardLarge :post-title="'My Title'" :post-slug="'slug'" :avatar-url="'#'" :post-summary="'Post Summary'"/>
